  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        alt ="profile pic"
        className='rounded-full w-56 h-56 object-cover cursor-pointer self-center m-2'/>
        ...
        uppercase hover:opacity-95 w-96 mx-auto'> 
        {loading ? 'Loading...' : 'Update'}
        </button>

        <Link to={'/create-listing'}
        className='bg-green-700 text-white p-3 text-center rounded-lg
        uppercase hover:opacity-95 w-96 mx-auto'>
          Create Listing
        </Link>
